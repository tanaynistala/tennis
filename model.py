...
class FlowNet(nn.Module):
    ...
    def forward(self, x):
        ...
        print(out_conv4.shape, out_deconv4.shape, flow5_up.shape)
        ...
        # concat3 = torch.cat((out_conv3, out_deconv3, flow4_up))
        # flow3 = self.predict_flow3(concat3)
        # flow3_up = self.flow3_2(flow3)
        # out_deconv2 = self.relu14(self.deconv2(concat3))

        # concat2 = torch.cat((out_conv2, out_deconv2, flow3_up))
        ...
        #     return out_conv6, out_conv5, out_conv4, out_conv3, out_conv2
        return out_conv6
